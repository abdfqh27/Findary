...
public class lihat_buku extends javax.swing.JFrame {
    ...
    public Boolean tidak_kosong(){
        return !(kode_buku.getText().equals("") || judul.getText().equals("") || penulis.getText().equals("") || tahun.getText().equals("") || kategori.getText().equals("") || jumlah.getText().equals(""));
    }
    ...
    private void initComponents() {
        ...
        tabel_buku.setFont(new java.awt.Font("SansSerif", 0, 15)); // NOI18N
        ...
        tabel_buku.setSelectionBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel7.add(penulis, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 164, 370, -1));
        ...
        tambah.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        tambah.setForeground(new java.awt.Color(255, 255, 255));
        tambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/plus.png"))); // NOI18N
    ...
    private void tabel_bukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_bukuMouseClicked
        ...
        penulis.setText(tabel_buku.getModel().getValueAt(baris, 2).toString());
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(tidak_kosong()){
            try {
                st = con.createStatement();
                String sql = "INSERT INTO tb_buku VALUES('"+ kode_buku.getText() +"','"+ judul.getText() +"','"+ penulis.getText() +"','"+ tahun.getText() +"', '"+ kategori.getText() +"','"+ jumlah.getText() +"')";
    ...
    private void ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahActionPerformed
        ...
        if(tidak_kosong()){
            try {
                st = con.createStatement();
                String sql = "UPDATE tb_buku SET judul='"+ judul.getText() +"', penulis='"+ penulis.getText() +"',tahun_terbit='"+ tahun.getText() +"',kategori='"+ kategori.getText() +"',jumlah='"+ jumlah.getText() +"' WHERE kode_buku='"+ kode_buku.getText() +"'";
                st.executeUpdate(sql);
    ...
    private void cariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cariKeyReleased
        ...
        try {
            ...
            rs = st.executeQuery("SELECT * FROM tb_buku WHERE kode_buku like '%"+ cr +"%'or judul like '%"+ cr +"%'or penulis like '%"+ cr +"%' or tahun_terbit like '%"+ cr +"%' or kategori like '%"+ cr +"%' or jumlah like '%"+ cr +"%' ORDER BY kode_buku DESC " );
             while (rs.next()){
                    Object[] data ={
                     rs.getString("kode_buku"),
                     rs.getString("judul"),
