...
public class lihat_anggota extends javax.swing.JFrame {
                ...
                if (jumint > 0) {
                    st = con.createStatement();
                        ...
                        if(rs2.next()){
                            ...
                            if(kode.length() == 1){
                               id_anggota.setText("MHS00"+kode);
                            }else if(kode.length() == 2){
                                id_anggota.setText("MHS0"+kode);
                            }else
                                id_anggota.setText("MHS"+kode);
                        }
                }else{
                    id_anggota.setText("MHS001");
                }
            }
    ...
    private void initComponents() {
        ...
        cari.setBackground(new java.awt.Color(0, 150, 199));
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/7. Search.png"))); // NOI18N
        ...
        tabel_anggota.setFont(new java.awt.Font("SansSerif", 0, 15)); // NOI18N
        ...
        tabel_anggota.setSelectionBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel7.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 75, 110, -1));
        ...
        jLabel18.setForeground(new java.awt.Color(2, 62, 138));
        ...
        reset.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        ...
        tambah.setBackground(new java.awt.Color(2, 62, 138));
        tambah.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        tambah.setForeground(new java.awt.Color(255, 255, 255));
        tambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/13. Plus.png"))); // NOI18N
        ...
        hapus.setBackground(new java.awt.Color(2, 62, 138));
        hapus.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        hapus.setForeground(new java.awt.Color(255, 255, 255));
        hapus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/14. Delete.png"))); // NOI18N
        hapus.setText("Hapus");
        ...
        ubah.setBackground(new java.awt.Color(2, 62, 138));
        ubah.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        ubah.setForeground(new java.awt.Color(255, 255, 255));
        ubah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/15. Refresh.png"))); // NOI18N
        ubah.setText("Ubah");
        ubah.setBorder(null);
        ...
        jLabel20.setForeground(new java.awt.Color(2, 62, 138));
