 ...
 * @author Kelompok 5
 */
public class detail_mhs extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    String sql;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/11. User.png"))); // NOI18N
        ...
        user_id.setBackground(new java.awt.Color(0, 150, 199));
        user_id.setFont(new java.awt.Font("SansSerif", 0, 16)); // NOI18N
        ...
        jk.setBackground(new java.awt.Color(0, 150, 199));
        jk.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        jk.setForeground(new java.awt.Color(255, 255, 255));
        jk.setText("jk");
        jk.setOpaque(true);

        telp.setBackground(new java.awt.Color(0, 150, 199));
        telp.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        telp.setForeground(new java.awt.Color(255, 255, 255));
        telp.setText("telp");
        telp.setOpaque(true);

        alamat.setBackground(new java.awt.Color(0, 150, 199));
        alamat.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        alamat.setForeground(new java.awt.Color(255, 255, 255));
        alamat.setText("alamat");
        alamat.setOpaque(true);

        stat.setBackground(new java.awt.Color(0, 150, 199));
        stat.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        stat.setForeground(new java.awt.Color(255, 255, 255));
        stat.setText("stat");
        stat.setOpaque(true);

        tgl_kembali.setBackground(new java.awt.Color(0, 150, 199));
        tgl_kembali.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        tgl_kembali.setForeground(new java.awt.Color(255, 255, 255));
        tgl_kembali.setText("-");
        tgl_kembali.setOpaque(true);

        kd_pinjam.setBackground(new java.awt.Color(0, 150, 199));
        kd_pinjam.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        kd_pinjam.setForeground(new java.awt.Color(255, 255, 255));
        kd_pinjam.setText("-");
        kd_pinjam.setOpaque(true);

        tgl_pinjam.setBackground(new java.awt.Color(0, 150, 199));
        tgl_pinjam.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
        tgl_pinjam.setForeground(new java.awt.Color(255, 255, 255));
        tgl_pinjam.setText("-");
        tgl_pinjam.setOpaque(true);

        judul.setBackground(new java.awt.Color(0, 150, 199));
        judul.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_mhs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_mhs().setVisible(true);
            }
        });
    }
